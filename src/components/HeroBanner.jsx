...
const HeroBanner = () => {
    ...
    return (
            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>munurigangadhar0987@gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Munuri Gangadhar</span>
                    </div>
                    <div className="max-w-[510px]">
                    Experienced full-stack web developer dedicated to crafting high-quality solutions with precision and passion. With over 2 years of hands-on expertise, I thrive on delivering impactful results while maintaining an unwavering focus on detail.
                    </div>
                </motion.div>
                {/* INTRO END */}
        ...
        <a href="https://www.linkedin.com/in/munuri" style={iconStyle}>
          <i className="fab fa-linkedin"></i>
        </a>
        <a href="https://github.com/Munuri-Gangadhar" style={iconStyle}>
